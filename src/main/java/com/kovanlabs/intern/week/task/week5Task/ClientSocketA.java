...
public class ClientSocketA {
    ...
    public static void sendMessageToOtherClient(String userName, DataOutputStream output) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            chatMultiProcessing.execute(() -> sendMessageToOtherClient(userName, output));
